sap.ui.define([
	"sap/ui/test/Opa5",
	"oup/pms/zpmsisbnckpt/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("oup.pms.zpmsisbnckpt.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "ZPMS_C_ISBN_COCKPIT/" + sObjectId;
