sap.ui.define([
	...
	return Opa5.extend("oup.pms.zpmsisbnckpt.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["oup/pms/zpmsisbnckpt/localService/mockserver"], function (mockserver) {
